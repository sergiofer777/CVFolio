...
export default function LandingPage() {
  ...
  return (
    <div className="cursor-custom">
      ...
      {/* ─── NAV ─── */}
      <nav
        className={`fixed top-0 left-0 right-0 z-50 flex items-center justify-between gap-3 px-4 py-3 sm:px-6 md:px-12 md:py-5 transition-all duration-500 bg-[rgba(245,242,235,0.96)] backdrop-blur-xl border-b border-[var(--sand)] max-sm:static max-sm:flex-wrap max-sm:gap-y-2 max-sm:bg-[var(--paper)] max-sm:backdrop-blur-none ${
          navScrolled
      ...
      {/* ─── HERO ─── */}
      <section className="min-h-screen flex flex-col items-center justify-center px-6 md:px-12 pt-40 sm:pt-36 md:pt-28 pb-20 relative overflow-hidden text-center max-sm:justify-start max-sm:pt-16">
